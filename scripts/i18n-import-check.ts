...
// i18n symbols that should be imported from @lumen/ui
...
const VALID_IMPORT_SOURCES = ['@lumen/ui']
...
function main() {
	...
	if (verbose) {
		console.log(theme.muted('  Tip: Import these symbols from @lumen/ui'))
		console.log(theme.muted('  Example: import { useVIntl, defineMessages } from \'@lumen/ui\''))
		console.log()
	}
