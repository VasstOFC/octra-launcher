...
export class ArchonNoticesV0Module extends AbstractModule {
	 ...
	 * PUT /Lumen/v0/notices/:id/assign?server=:serverId
	 * PUT /Lumen/v0/notices/:id/assign?node=:nodeId
	 */
	 ...
	 * PUT /Lumen/v0/notices/:id/unassign?server=:serverId
	 * PUT /Lumen/v0/notices/:id/unassign?node=:nodeId
	 */
