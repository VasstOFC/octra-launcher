...
pub async fn get_user_profile(user_id: &str) -> crate::Result<Value> {
    ...
    fetch_json(
        Method::GET,
        &format!("{}user/{}", env!("LUMEN_API_URL_V3"), user_id),
        None,
        None,
        Some("/v3/user/:id"),
        &state.api_semaphore,
...
pub async fn get_user_projects(user_id: &str) -> crate::Result<Value> {
    ...
    fetch_json(
        Method::GET,
        &format!("{}user/{}/projects", env!("LUMEN_API_URL_V3"), user_id),
        None,
        None,
...
pub async fn patch_user(user_id: &str, patch: Value) -> crate::Result<()> {
    ...
    fetch_advanced(
        Method::PATCH,
        &format!("{}user/{}", env!("LUMEN_API_URL"), user_id),
        None,
        Some(patch),
        None,
        None,
...
pub async fn delete_user_avatar(user_id: &str) -> crate::Result<()> {
    ...
    fetch_advanced(
        Method::DELETE,
        &format!("{}user/{}/icon", env!("LUMEN_API_URL"), user_id),
        None,
        None,
        None,
        None,
...
pub async fn block_user(user_id: &str) -> crate::Result<()> {
    ...
    fetch_advanced(
        Method::POST,
        &format!("{}block/{}", env!("LUMEN_API_URL_V3"), user_id),
        None,
        None,
        None,
        None,
...
pub async fn get_blocked_users() -> crate::Result<Vec<String>> {
    ...
    fetch_json(
        Method::GET,
        &format!("{}blocks", env!("LUMEN_API_URL_V3")),
        None,
        None,
        Some("/v3/blocks"),
        &state.api_semaphore,
