...
const INTERCOM_STYLE_ID = 'Lumen-hosting-intercom-style'
const LAUNCHER_SELECTOR =
	".intercom-lightweight-app-launcher, .intercom-launcher-frame, iframe[name='intercom-launcher-frame']"
const RIGHT_VAR = '--Lumen-hosting-intercom-right'
const BOTTOM_VAR = '--Lumen-hosting-intercom-bottom'
const POINTER_EVENTS_VAR = '--Lumen-hosting-intercom-pointer-events'
