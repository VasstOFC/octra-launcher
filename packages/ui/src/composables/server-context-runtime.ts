import type { AbstractLumenClient, Archon } from '@lumen/api-client'
...
const runtimesByClient = new WeakMap<AbstractLumenClient, Map<string, ServerContextRuntime>>()

function getClientRuntimes(client: AbstractLumenClient) {
