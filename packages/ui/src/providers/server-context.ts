...
export interface LumenServerContext {
...
export const [injectLumenServerContext, provideLumenServerContext] =
	createContext<LumenServerContext>('[id].vue', 'LumenServerContext')
