...
import { InfoIcon, SpinnerIcon, XIcon } from '@lumen/assets'
...
import type { RegionPing, ServerBillingInterval } from './LumenServersPurchaseModal.vue'
...
const messages = defineMessages({
	...
	regionUnsupported: {
		...
		defaultMessage: `Region not listed? <link>Let us know where you'd like to see Lumen Hosting next!</link>`,
	},
	customPrompt: {
				...
				<IntlFormatted :message-id="messages.regionUnsupported">
					<template #link="{ children }">
						<a
							...
							href="https://surveys.Lumen.com/servers-region-waitlist"
						>
