...
import { type Archon, type Labrinth, pingWebSocketUrl } from '@lumen/api-client'
import {
	CheckCircleIcon,
	ChevronRightIcon,
	LeftArrowIcon,
...
const debug = useDebugLogger('LumenServersPurchaseModal')
...
const purchaseSuccessText = defineMessage({
	...
	defaultMessage: 'Your Lumen Hosting purchase was completed successfully.',
})
