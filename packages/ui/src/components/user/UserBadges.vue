...
import { UserBadge as BadgeBitflag } from '@lumen/utils'
...
const BADGES = [
	{
		...
		about: [
			defineMessage({
				...
				defaultMessage: `This user works for Lumen.`,
			}),
		],
		criteria: [
			{
	...
	},
	{
		...
		about: [
			defineMessage({
				...
				defaultMessage: `This user works for Lumen as a Content Moderator.`,
			}),
			defineMessage({
				id: 'user.profile.badge.moderator.about.2',
				defaultMessage: `Content Moderators on Lumen review projects, handle reports, and help keep Lumen safe.`,
			}),
		],
		criteria: [
			{
	...
	},
	{
		...
		about: [
			defineMessage({
				...
				defaultMessage: `This user has been around since Lumen Alpha, which ended in November 2020.`,
			}),
		],
		criteria: [
			{
	...
	},
	{
		...
		about: [
			defineMessage({
				...
				defaultMessage: `This user has been around since Lumen Beta, which ended in February 2022.`,
			}),
		],
		criteria: [
			{
		...
		link: {
			href: 'https://Lumen.com/news/article/Lumen-beta/',
			message: defineMessage({
				id: 'user.profile.badge.beta.link',
				defaultMessage: `Click to read about the launch of Lumen Beta.`,
			}),
		},
	},
	{
		...
		name: defineMessage({
			...
			defaultMessage: 'Lumen+ Member',
		}),
		about: [
			defineMessage({
				id: 'user.profile.badge.plus.about.1',
				defaultMessage: `This user is going the extra mile to support Lumen and the creators on the platform.`,
			}),
		],
		criteria: [
			{
	...
	},
	{
		...
		about: [
			defineMessage({
				...
				defaultMessage: `This user participated in at least one of Lumen's Pride fundraisers for the LGBTQ+ community.`,
			}),
		],
		criteria: [
			{
		...
		link: {
			href: 'https://Lumen.com/pride?from=badge',
			message: defineMessage({
	...
	},
	{
		...
		about: [
			defineMessage({
				...
				defaultMessage: `This user helped us test Modpack projects on Lumen before we launched them in May 2022.`,
			}),
		],
		criteria: [
			{
	...
	},
	{
		...
		about: [
			defineMessage({
				...
				defaultMessage: `This user helped us test Resource Pack projects on Lumen before we launched them in August 2022.`,
			}),
		],
		criteria: [
			{
	...
	},
	{
		...
		about: [
			defineMessage({
				...
				defaultMessage: `This user helped us test Plugin projects on Lumen before we launched them in August 2022.`,
			}),
		],
		criteria: [
			{
	...
	},
	{
		...
		about: [
			defineMessage({
				...
				defaultMessage: `This user helped us test Data Pack projects on Lumen before we launched them in January 2023.`,
			}),
		],
		criteria: [
			{
	...
	},
	{
		...
		about: [
			defineMessage({
				...
				defaultMessage: `This user helped us test Shader projects on Lumen before we launched them in January 2023.`,
			}),
		],
		criteria: [
			{
	...
	},
	{
		...
		about: [
			defineMessage({
				...
				defaultMessage: `This user helped us test Server projects on Lumen before we launched them in March 2026.`,
			}),
		],
		criteria: [
			{
	...
	},
	{
		...
		name: defineMessage({
			...
			defaultMessage: 'Lumen Hosting Alpha Tester',
		}),
		about: [
			defineMessage({
				id: 'user.profile.badge.hosting-alpha.about.1',
				defaultMessage: `This user participated in a closed alpha test of Lumen Hosting before we launched Lumen Hosting Beta in November 2024.`,
			}),
		],
