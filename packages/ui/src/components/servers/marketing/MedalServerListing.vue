<template>
	...
	>
		...
		>
			...
			>
				<Avatar src="https://cdn-raw.Lumen.com/medal_icon.webp" size="64px" class="opacity-50" />
				<SpinnerIcon
					v-if="isUpgrading"
			...
			<Avatar v-else src="https://cdn-raw.Lumen.com/medal_icon.webp" size="64px" class="z-10" />
...
import { LockIcon, RocketIcon, SparklesIcon, SpinnerIcon } from '@lumen/assets'
...
const messages = defineMessages({
	...
	suspendedWithReasonNotice: {
		...
		defaultMessage:
			'Your server has been suspended: {reason}. Please update your billing information or contact Lumen Support for more information.',
	},
	suspendedNotice: {
		id: 'servers.medal-listing.notice.suspended',
		defaultMessage:
			'Your server has been suspended. Please update your billing information or contact Lumen Support for more information.',
	},
})
