				...
				<div class="flex flex-col gap-2">
					<div class="flex items-center gap-3">
						<h1 class="m-0 text-3xl font-semibold leading-9 text-contrast">
							{{ formatMessage(messages.LumenHostingLabel) }}
						</h1>
					</div>
...
const messages = defineMessages({
	LumenHostingLabel: {
		id: 'servers.list-empty.Lumen-hosting-label',
		defaultMessage: 'Lumen Hosting',
	},
	noServersDescription: {
		id: 'servers.list-empty.no-servers-description',
		defaultMessage: 'Install mods, invite friends, and play together all from the Lumen App.',
	},
	...
	playWithFriendsDescription: {
		...
		defaultMessage: 'Invite friends to play your server with one-click play from the Lumen App.',
	},
	newServerButton: {
