...
class AdsConsentController {
	...
	syncConsentPopup() {
		...
		if (!cmpMain) {
			...
			if (this.state.phase === 'idle') {
				document.documentElement.classList.remove('Lumen-ads-consent-overlay')
		...
		document.documentElement.classList.add('Lumen-ads-consent-overlay')
	...
	async reopenPreferences() {
		if (document.documentElement.classList.contains('Lumen-ads-consent-overlay')) {
			try {
				await this.openPreferences()
			} catch {
				this.showNativeCmpFallback()
	...
	/** @returns {void} */
	preparePreferences() {
		document.documentElement.classList.add('Lumen-ads-consent-preferences')
		document.documentElement.classList.remove('Lumen-ads-consent-preferences-visible')
	}

	/** @returns {void} */
	revealPreferences() {
		document.documentElement.classList.add('Lumen-ads-consent-preferences-visible')
	}

	/** @returns {void} */
	concealPreferences() {
		document.documentElement.classList.remove('Lumen-ads-consent-preferences')
		document.documentElement.classList.remove('Lumen-ads-consent-preferences-visible')
	}
	...
	setPopupMode(mode) {
		...
		document.documentElement.classList.toggle('Lumen-ads-consent-overlay', shown)
		document.documentElement.classList.toggle('Lumen-ads-consent-fallback', mode === 'fallback')
