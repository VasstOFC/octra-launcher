...
const messages = defineMessages({
	downloadLumenApp: {
		id: 'app-marketing.hero.download-Lumen-app',
		defaultMessage: 'Download Lumen App',
	},
	downloadLumenAppForOs: {
		id: 'app-marketing.hero.download-Lumen-app-for-os',
		defaultMessage: 'Download Lumen App for {os}',
	},
	description: {
		id: 'app-marketing.hero.description',
		defaultMessage:
			'Lumen App is a unique, open source launcher that allows you to play your favorite mods, and keep them up to date, all in one neat little package.',
	},
	downloadLumenAppButton: {
	...
	modManagementDescription: {
		...
		defaultMessage:
			'Lumen makes it easy to manage all your mods in one place. You can install, uninstall, and update mods with a single click.',
	},
	...
	playWithFavoriteModsDescription: {
		...
		defaultMessage: 'Use Lumen App to download and play with your favorite mods and modpacks.',
	},
	shareModpacks: {
	...
	shareModpacksDescription: {
		...
		defaultMessage:
			'Build, share, and play modpacks with any of the thousands of mods and modpacks hosted here on Lumen.',
	},
	share: {
	...
	LumenApp: {
		id: 'app-marketing.features.performance.Lumen-app',
	...
	performantDescription: {
		...
		defaultMessage:
			'Lumen App performs better than many of the leading mod managers, using just 150 MB of RAM!',
	},
	websiteIntegration: {
	...
	websiteIntegrationDescription: {
		...
		defaultMessage:
			'Lumen App is fully integrated with the website, so you can access all your favorite projects from the app!',
	},
	profileImporting: {
	...
	profileImportingDescription: {
		...
		defaultMessage:
			'Import all your favorite profiles from the launcher you were using before, and get started with Lumen App in seconds!',
	},
	openSource: {
	...
	openSourceDescription: {
		...
		defaultMessage:
			"Lumen's launcher is fully open source. You can view the source code on our <github-link>GitHub</github-link>!",
	},
	offlineMode: {
	...
	downloadLumenAppBeta: {
		id: 'app-marketing.download.title',
		defaultMessage: 'Download Lumen App (Beta)',
	},
	downloadDescription: {
	...
	downloadTerms: {
		...
		defaultMessage:
			'By downloading Lumen App, you agree to our <terms-link>Terms</terms-link> and <privacy-link>Privacy Policy</privacy-link>.',
	},
	linuxDisclaimer: {
		id: 'app-marketing.download.linux-disclaimer',
		defaultMessage:
			'The Linux versions of Lumen App are <issues-link>known to have issues</issues-link> on certain systems and configurations. If Lumen App is unstable on your system, we encourage you to try other apps like <prism-link>Prism Launcher</prism-link> to easily install Lumen content.',
	},
	appScreenshotAlt: {
		id: 'app-marketing.hero.app-screenshot-alt',
		defaultMessage: `Screenshot of Lumen App with a Cobblemon instance opened to the 'Content' page.`,
	},
...
const title = 'Download Lumen App!'
const description =
	'Lumen App is a unique, open source launcher that allows you to play your favorite mods, and keep them up to date, all in one neat little package.'
	...
	<div>
		<div class="landing-hero">
			...
			<h1 class="main-header max-w-[60rem]">
				{{
					os
						? formatMessage(messages.downloadLumenAppForOs, { os: osName })
						: formatMessage(messages.downloadLumenApp)
				}}
			</h1>
			...
			<div class="mx-auto flex w-fit flex-wrap justify-center gap-2 [mask-image:none]">
				<Button v-if="os" type="colored" color="brand" size="xl" @click="handleDownload">
					...
					{{ formatMessage(messages.downloadLumenAppButton) }}
				</Button>
			...
			<img src="https://cdn-raw.Lumen.com/app-landing/app-screenshot.webp" alt="" />
		...
		<div class="features">
			...
			<div class="feature-grid">
				...
				<div class="feature gradient-border playing">
					...
					<img
						src="https://cdn-raw.Lumen.com/app-landing/cobblemon-launcher.webp"
						:alt="formatMessage(messages.appScreenshotAlt)"
						class="launcher"
					/>
					<img
						src="https://cdn-raw.Lumen.com/app-landing/cobblemon.webp"
				...
				<div class="feature gradient-border performance">
					...
					<div class="table">
						<div class="row first">
							<div class="cell">
								<div>
									<div class="icon-logo Lumen">
										<LogoAnimated class="icon" />
									</div>
								</div>
							</div>
							<div class="cell important">{{ formatMessage(messages.LumenApp) }}</div>
		...
		<div ref="downloadSection" class="footer">
			...
			<div class="section-subheader">
				<div class="section-subheader-title">
					{{ formatMessage(messages.downloadLumenAppBeta) }}
				</div>
			...
			<div class="download-section">
				...
				<div class="download-card">
					...
					<div class="description apple">
						<a href="https://flathub.org/en/apps/com.Lumen.LumenApp" target="_blank">
							<FlathubIcon />
...
.landing-hero {
	position: relative;
	background: #0f1121 url('https://cdn-raw.Lumen.com/app-landing/cube-black.png') no-repeat
		center 4rem;
...
.light-mode {
	...
	.landing-hero {
		background: url('https://cdn-raw.Lumen.com/app-landing/cube-light.png') no-repeat center 4rem;
		background-size: cover;
	}
