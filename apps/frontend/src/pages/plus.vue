<template>
	...
	<div class="main-hero">
		<div class="flex max-w-screen-lg flex-col items-center gap-4 text-center">
			<LumenPlusIcon class="h-8 w-max text-contrast" />
			<h1 class="m-0 text-[4rem]">Support creators and go ad-free</h1>
			<p class="m-0 mb-4 text-[18px] leading-relaxed">
				Subscribe to Lumen Plus to go ad-free, support Lumen's development, and get an
				exclusive profile badge! Half your subscription goes directly to Lumen creators. Cancel
				anytime.
			</p>
	...
	<div class="perks-hero">
		<h2>What you get with Lumen Plus!</h2>
		<div class="mt-8 grid max-w-screen-lg gap-8 lg:grid-cols-3">
			<div class="flex flex-col gap-4 rounded-xl bg-bg-raised p-4">
				...
				<span class="text-lg font-bold">Support Lumen creators</span>
				<span class="leading-5 text-secondary">
					50% of your subscription goes directly to Lumen creators.
				</span>
			</div>
			<div class="flex flex-col gap-4 rounded-xl bg-bg-raised p-4">
				...
				<span class="leading-5 text-secondary">
					Never see an advertisement again on the Lumen app.
				</span>
			</div>
			<div class="flex flex-col gap-4 rounded-xl bg-bg-raised p-4">
...
<script setup>
import { HeartIcon, LumenPlusIcon, SettingsIcon, SparklesIcon, StarIcon } from '@lumen/assets'
import {
	Button,
	ButtonLink,
...
const title = 'Subscribe to Lumen Plus!'
const description =
	"Subscribe to Lumen Plus to go ad-free, support Lumen's development, and get an exclusive profile badge! Half your subscription goes directly to Lumen creators."
