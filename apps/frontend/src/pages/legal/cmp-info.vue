<template>
	<div class="markdown-body">
		...
		<p>
			This page was created for transparency for how the rewards program works on Lumen. Feel
			free to join our Discord or email
			<a href="mailto:support@Lumen.com">support@Lumen.com</a> if you have any questions!
		</p>
		<p>
			This document is provided for informational purposes only and does not constitute a legal
			agreement. Lumen makes no representations or warranties as to the accuracy, completeness,
		...
		<p>In this scenario, the earnings for each creator and Lumen would be as follows:</p>
		<ul>
			<li>Lumen: $25 (25% of $100, the site's earnings for the day)</li>
		...
		<p>
			...
			downloads are counted equally. In each category, Lumen actively removes botted downloads
			and page views at our own discretion. If users are caught botting, they will be permanently
			banned from using Lumen's services.
		</p>
		<p>
			You can view your page views and project downloads in your
			<a href="https://Lumen.com/dashboard/analytics">analytics dashboard</a>.
		</p>
		...
		<p>
			No. All creators who upload to Lumen automatically will receive funds as according to the
		...
		<p>
			Right now, you can use PayPal or Venmo to withdraw money from your Lumen account. Gift card
			withdrawal is also available. We are working on more methods to withdraw money from your
			account. There are fees to withdraw money from your Lumen account—see the revenue page in
			your dashboard for more information.
		</p>
		<h3 id="pending">What does "pending" revenue mean in my dashboard?</h3>
		<p>
			Lumen receives ad revenue from our ad providers on a NET 60 day basis. Due to this, not all
		...
		<h3>How do I know Lumen is being transparent about revenue?</h3>
		<p>
			...
			to query the exact daily advertising revenue for the site - so far, creators on Lumen have
		...
		<small
			>Lumen's total ad revenue in the previous 5 days, for the entire dataset, use the
			aforementioned
...
import { DatePicker, injectLumenClient, useFormatDateTime, useFormatMoney } from '@lumen/ui'
...
const description =
	'Information about the Rewards Program of Lumen, an open source modding platform focused on Minecraft.'

useSeoMeta({
	title: 'Rewards Program Information - Lumen',
	description,
