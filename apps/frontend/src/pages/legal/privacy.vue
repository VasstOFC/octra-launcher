<template>
	<div class="markdown-body">
		...
		<h2>Introduction</h2>
		<p>
			<a href="https://Lumen.com">Lumen</a> is part of Rinth, Inc. ("Company", "us", "we",
		...
		<p>
			...
			when you use www.Lumen.com, api.modrinth.com, or the Lumen App ("Service" or "Website"),
		...
		<p>Rinth, Inc. is the data controller for data collected through Lumen.</p>
		...
		<p>When you view a project page or download a file from Lumen, we collect:</p>
		<ul>
		...
		<h3>Playtime data</h3>
		<p>When you use the Lumen App to play Lumen projects, we collect:</p>
		<ul>
			<li>Your IP address</li>
			<li>Your user ID</li>
		...
		<h3>Usage data</h3>
		<p>When you interact with the Lumen App or the Website, we collect through PostHog:</p>
		<ul>
			<li>Your IP address</li>
		...
		<p>
			We use some third-party services to make Lumen run. Please refer to each of their privacy
		...
		<p>
			...
			<a href="mailto:gdpr@Lumen.com">gdpr@Lumen.com</a>. We may ask you to verify your
		...
		<p>
			Lumen does not knowingly collect any Personal Identifiable Information from children under
		...
		<p>
			...
			website with regards to the information that they shared and/or collect in Lumen. This
		...
		<p>
			...
			<a href="mailto:gdpr@Lumen.com">gdpr@Lumen.com</a> or write us at:
		</p>
		<p>
			Rinth, Inc.<br />
...
<script setup>
const description =
	'The Privacy Policy of Lumen, an open source modding platform focused on Minecraft.'
