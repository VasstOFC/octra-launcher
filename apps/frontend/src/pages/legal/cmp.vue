<template>
	<div class="markdown-body">
		...
		<p>
			...
			the Lumen Rewards Program (the "Rewards Program").
		</p>
		<p>
			The Rewards Program provides developers and content creators an opportunity to monetize the
			projects ("Projects") that they upload to the Lumen website.
		</p>
		<p>
		...
		<p>
			...
			attributable to ad impressions displayed on Lumen.com and the Lumen App excluding
...
<script setup>
const description =
	'The Rewards Program Terms of Lumen, an open source modding platform focused on Minecraft.'

useSeoMeta({
	title: 'Rewards Program Terms - Lumen',
	description,
