...
const messages = defineMessages({
	...
	infoBannerDescription: {
		...
		defaultMessage: `If you include content that isn’t hosted on Lumen, you need to let us know where it’s from and verify that you have permission to distribute the files. Check out <link>our announcement of this new system</link> to learn more!`,
	},
	learnMore: {
	...
	failDescription: {
		...
		defaultMessage: `You may not have permission to redistribute some of the external content in your project. In order to publish on Lumen, please remove this content or provide proof that you do have permission to use it.`,
	},
	notAllowedDescription: {
		id: 'project.settings.permissions.not-allowed.description',
		defaultMessage: `Some of the external content included cannot be distributed on Lumen because it violates our Content Rules and must be removed.`,
	},
	badProofTitle: {
	...
	badProofDescription: {
		...
		defaultMessage: `Lumen's moderation team has rejected the permission information you provided for some external content. Please review the rejected items below and provide acceptable proof or remove the content.`,
	},
