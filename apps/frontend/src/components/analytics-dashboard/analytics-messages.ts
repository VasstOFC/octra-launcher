import { defineMessages, getLoaderMessage, type VIntlFormatters } from '@lumen/ui'
...
export const analyticsStatCardMessages = defineMessages({
	...
	monetizationBannerBody: {
		...
		defaultMessage:
			'Only views and downloads made through Lumen are eligible for monetization and must pass fraud-prevention filtering. Lumen App downloads also require the user to be logged in. Because all projects have a similar ratio of monetized downloads, your revenue would not meaningfully change if all downloads were counted.',
	},
...
export const analyticsTableMessages = defineMessages({
	...
	csvFilename: {
		...
		defaultMessage: 'Lumen Analytics {breakdown} Breakdown - {dateRange}',
	},
	durationDays: {
...
export const analyticsChartMessages = defineMessages({
	...
	LumenEvents: {
		id: 'analytics.chart.controls.Lumen-events',
		defaultMessage: 'Lumen events',
	},
	noProjectEvents: {
	...
	noLumenEvents: {
		id: 'analytics.chart.controls.no-Lumen-events',
		defaultMessage: 'No Lumen events in graph.',
	},
	...
	monetizedAnalyticsDetailsDescription: {
		...
		defaultMessage:
			'Only views and downloads made through Lumen count toward monetization, and downloads require users to be logged in.',
	},
...
export function formatAnalyticsDownloadSourceLabel(
	...
	if (normalizedLowercase === 'Lumen_app') {
