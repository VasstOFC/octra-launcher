...
const messages = defineMessages({
	...
	body1: {
		...
		defaultMessage:
			'Using AI-generated images to represent your project is not allowed. Attempting to work around detection may lead to your Lumen account being suspended.',
	},
	body2: {
		id: 'project.ai-image-warning-modal.body.2',
		defaultMessage: `See section 6 of <rules>Lumen's Content Rules</rules> for more information on our generative AI policy.`,
	},
})
