...
import { XCircleIcon, XIcon } from '@lumen/assets'
import { Button, defineMessages, PagewideBanner, useVIntl } from '@lumen/ui'
...
const messages = defineMessages({
	...
	description: {
		...
		defaultMessage:
			"This deploy of Lumen's frontend failed to generate state from the API. This may be due to an outage or an error in configuration. Rebuild when the API is available. Error codes: {errors}; Current API URL is: {url}",
	},
	ignoreErrors: {
