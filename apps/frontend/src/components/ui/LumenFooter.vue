...
import { commonSettingsMessages } from '@lumen/ui/src/utils/common-messages.js'
...
const messages = defineMessages({
	LumenInformation: {
		id: 'layout.footer.Lumen-information',
		defaultMessage: 'Lumen information',
	},
	openSource: {
		id: 'layout.footer.open-source',
		defaultMessage: 'Lumen is <github-link>open source</github-link>.',
	},
	legalDisclaimer: {
...
const socialLinks: {
	...
	},
	{
		...
		href: 'https://www.reddit.com/r/Lumen',
		icon: RedditIcon,
	},
]
...
const footerLinks: {
	...
	},
	{
		...
		links: [
			{
				href: '/plus',
				label: defineMessage({ id: 'layout.footer.products.plus', defaultMessage: 'Lumen+' }),
			},
			{
				href: '/app',
				label: defineMessage({ id: 'layout.footer.products.app', defaultMessage: 'Lumen App' }),
			},
			{
				href: '/hosting',
				label: defineMessage({
	...
	},
	{
		...
		links: [
			...
			{
				href: 'https://translate.Lumen.com',
				label: defineMessage({
			...
			{
				href: 'https://github.com/VasstOFC/octra-launcher/issues',
				label: defineMessage({
		...
		<div class="mx-auto flex max-w-screen-xl flex-col gap-6 p-6 pb-20 sm:px-12 md:py-12">
			...
			>
				<div
					...
					role="region"
					:aria-label="formatMessage(messages.LumenInformation)"
				>
						...
						<p class="m-0">
							<IntlFormatted :message-id="messages.openSource">
								<template #github-link="{ children }">
									<a
										href="https://github.com/VasstOFC/octra-launcher"
