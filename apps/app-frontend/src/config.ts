...
const siteUrl = trimTrailingSlash(import.meta.env.Lumen_URL || 'https://Lumen.com')
const labrinthBaseUrl = trimTrailingSlash(
	import.meta.env.Lumen_API_BASE_URL || 'https://api.modrinth.com',
)
const archonBaseUrl = trimTrailingSlash(
	import.meta.env.Lumen_ARCHON_BASE_URL || 'https://archon.modrinth.com',
)
