import type { LoadingStateProvider } from '@lumen/ui'
import { createLoadingStateCore, provideLoadingState } from '@lumen/ui'

/**
 * Source of truth for the desktop app's loading state.
 *
 * Owns the token-based ref-counter directly. Consumers
 * obtain the same reactive state via `injectLoadingState()` from `@lumen/ui`.
 *
