...
const messages = defineMessages({
	...
	usernamePlaceholder: {
		id: 'Lumen-account.username',
		defaultMessage: 'Minecraft nickname',
	},
	passwordPlaceholder: {
		id: 'Lumen-account.password',
		defaultMessage: 'Password',
	},
	registerHint: {
		id: 'Lumen-account.register-hint',
		defaultMessage:
			'Lumen links to your current Minecraft account for skins. It does not create a Minecraft account.',
	},
	linkedMinecraft: {
		id: 'Lumen-account.linked-minecraft',
		defaultMessage: 'Minecraft account',
	},
	noMinecraftAccount: {
		id: 'Lumen-account.no-minecraft',
	...
	loginSuccess: {
		id: 'Lumen-account.login-success',
		defaultMessage: 'Logged in to Lumen',
	},
	registerSuccess: {
		id: 'Lumen-account.register-success',
		defaultMessage: 'Lumen account linked',
	},
})
