...
export const minecraftAuthErrors: MinecraftAuthError[] = [
	{
		...
		whatHappened:
			'Your saved Microsoft sign-in token has expired or was revoked, so Lumen App cannot refresh your Minecraft session.',
		stepsToFix: [
			'Sign out of the affected Minecraft account in Lumen App',
	...
	},
	{
		...
		stepsToFix: [
			...
			'Restart Lumen App after waiting',
	...
	},
	{
		...
		whatHappened:
			"Minecraft's authentication service is returning a server error, so Lumen App cannot finish signing you in right now.",
		stepsToFix: [
	...
	},
	{
		...
		stepsToFix: [
			...
			'Try signing in to Lumen App again',
		],
	},
	{
		matches: (message) =>
		...
		whatHappened:
			'Lumen App could not connect to a Microsoft, Xbox, or Minecraft service needed for sign-in. This is usually caused by a local network, DNS, proxy, firewall, hosts file, VPN, or antivirus issue.',
		stepsToFix: [
			'Restart Lumen App and try signing in again',
			'Check that your internet connection is working',
			'Allow Lumen App through your firewall, antivirus, proxy, VPN, and hosts file rules',
	...
	},
	{
		...
		whatHappened:
			'Xbox services rejected the request to authorize this account for Minecraft services, but did not return a specific account restriction that Lumen App recognizes.',
		stepsToFix: [
			'Sign in with the <a href="https://www.minecraft.net/en-us/download">official Minecraft Launcher</a>',
