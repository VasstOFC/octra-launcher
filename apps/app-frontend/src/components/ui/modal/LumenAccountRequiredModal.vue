...
import { LogInIcon, RefreshCwIcon, SpinnerIcon, UserPlusIcon, XIcon } from '@lumen/assets'
import {
	Button,
	commonMessages,
	defineMessages,
...
import { cancelLogin, type LumenAuthFlow } from '@/helpers/mr_auth'

const props = defineProps<{
	requestAuth: (flow: LumenAuthFlow, addAccount?: boolean) => Promise<boolean>
}>()

const { formatMessage } = useVIntl()
const modal = ref<InstanceType<typeof NewModal>>()
const authenticating = ref<LumenAuthFlow | null>(null)
...
function showSigningIn(flow: LumenAuthFlow = 'sign-in', addAccount = false, event?: MouseEvent) {
...
function authenticate(flow: LumenAuthFlow, addAccount = false) {
...
const messages = defineMessages({
	header: {
		id: 'modal.Lumen-account-required.header',
		defaultMessage: 'Account required',
	},
	signingInHeader: {
		id: 'modal.Lumen-account-required.signing-in-header',
		defaultMessage: 'Signing in',
	},
	signInHeading: {
		id: 'modal.Lumen-account-required.sign-in-heading',
		defaultMessage: 'Sign in to a Lumen account',
	},
	description: {
		id: 'modal.Lumen-account-required.description',
		defaultMessage: "You'll need to sign into your Lumen account before you can use this feature.",
	},
	createAccountButton: {
		id: 'modal.Lumen-account-required.create-account-button',
		defaultMessage: 'Create an account',
	},
	signInButton: {
		id: 'modal.Lumen-account-required.sign-in-button',
		defaultMessage: 'Sign in to Lumen',
	},
	continueInBrowserHeading: {
		id: 'modal.Lumen-account-required.continue-in-browser-heading',
		defaultMessage: 'Continue in your browser',
	},
	browserDescription: {
		id: 'modal.Lumen-account-required.browser-description',
		defaultMessage:
			'A new tab opened to sign in. Complete the sign in there, then return to the app.',
	},
	waitingForBrowser: {
		id: 'modal.Lumen-account-required.waiting-for-browser',
		defaultMessage: 'Waiting for browser confirmation...',
	},
	openBrowserAgainButton: {
		id: 'modal.Lumen-account-required.open-browser-again-button',
		defaultMessage: 'Open browser again',
	},
	supportPrompt: {
		id: 'modal.Lumen-account-required.support-prompt',
